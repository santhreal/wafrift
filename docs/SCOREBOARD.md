...
_Generated 2026-09-04 from `wafrift-bench/results/` via `wafrift-bench/scripts/render-scoreboard.py`. Numbers are the **verified-bypass** rate per payload class, oracle-gated, transport-reached, no inflation. Cell = % of variants for that class that wafrift found a working bypass for; `: ` = class not exercised on that stack._

| class | modsec-pl1 | modsec-pl2 | modsec-pl3 | modsec-pl4 | coraza | bunkerweb | naxsi |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| sql | 36.2 | 30.3 | 30.1 | 39.1 | 8.7 | 39.4 | 30.0 |
| xss | 30.6 | 26.2 | 26.2 | :  | :  | :  | :  |
| cmdi | 46.4 | 29.0 | 28.9 | :  | :  | :  | :  |
| ssti | 42.4 | 32.1 | 30.8 | :  | :  | :  | :  |
| path | 40.4 | 29.7 | 29.1 | :  | :  | :  | :  |
...
| xxe | 28.7 | 25.9 | 25.9 | :  | :  | :  | :  |
| ssrf | 44.6 | 27.1 | 27.4 | :  | :  | :  | :  |
| nosql | 47.9 | 33.1 | 30.7 | :  | :  | :  | :  |
| log4shell | 45.6 | 33.0 | 32.0 | :  | :  | :  | :  |
