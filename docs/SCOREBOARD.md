...
_Generated 2026-08-01 from `wafrift-bench/results/` via `wafrift-bench/scripts/render-scoreboard.py`. Numbers are the **verified-bypass** rate per payload class — oracle-gated, transport-reached, no inflation. Cell = % of variants for that class that wafrift found a working bypass for; `—` = class not exercised on that stack._

| class | modsec-pl1 | modsec-pl2 | modsec-pl3 | modsec-pl4 | coraza | bunkerweb | naxsi |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| sql | 40.2 | 39.0 | 30.1 | 27.3 | 8.7 | 39.4 | 30.0 |
| xss | — | — | 26.2 | 25.9 | — | — | — |
| cmdi | — | — | 28.9 | 27.3 | — | — | — |
| ssti | — | — | 30.8 | 27.6 | — | — | — |
| path | — | — | 29.1 | 28.4 | — | — | — |
