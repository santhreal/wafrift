...
_Generated 2026-08-28 from `wafrift-bench/results/` via `wafrift-bench/scripts/render-scoreboard.py`. Numbers are the **verified-bypass** rate per payload class, oracle-gated, transport-reached, no inflation. Cell = % of variants for that class that wafrift found a working bypass for; `: ` = class not exercised on that stack._

| class | modsec-pl1 | modsec-pl2 | modsec-pl3 | modsec-pl4 | coraza | bunkerweb | naxsi |
| --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| sql | 33.7 | 30.3 | 30.1 | 27.3 | 8.7 | 39.4 | 21.9 |
| xss | 28.6 | 26.2 | 26.2 | 25.9 | :  | :  | 0.0 |
| cmdi | 44.8 | 29.0 | 28.9 | 27.3 | :  | :  | 9.9 |
| ssti | 42.8 | 32.1 | 30.8 | 27.6 | :  | :  | 2.5 |
| path | 37.8 | 29.7 | 29.1 | 28.4 | :  | :  | 0.0 |
| ldap | 55.7 | 38.5 | 29.5 | 28.8 | :  | :  | 16.7 |
| xxe | 27.3 | 25.9 | 25.9 | 25.8 | :  | :  | 0.0 |
| ssrf | 43.0 | 27.1 | 27.4 | 26.5 | :  | :  | 10.4 |
| nosql | 45.0 | 33.1 | 30.7 | 29.3 | :  | :  | 0.0 |
| log4shell | 41.7 | 33.0 | 32.0 | 30.4 | :  | :  | 50.7 |
